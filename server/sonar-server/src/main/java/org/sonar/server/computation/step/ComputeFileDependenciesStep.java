...
public class ComputeFileDependenciesStep implements ComputationStep {
  ...
  public void execute(ComputationContext context) {
    ...
    recursivelyProcessComponent(context, rootComponentRef, rootComponentRef);
  }

  private void recursivelyProcessComponent(ComputationContext context, int componentRef, int parentModuleRef) {
    BatchReportReader reportReader = context.getReportReader();
    BatchReport.Component component = reportReader.readComponent(componentRef);
    for (Integer childRef : component.getChildRefList()) {
      recursivelyProcessComponent(context, childRef, componentRef);
    }
    ...
    if (component.getType().equals(Constants.ComponentType.FILE)) {
      ...
      processDirDependencies(context, component);
    }
  }
  ...
  private void processDirDependencies(ComputationContext context, BatchReport.Component component) {
